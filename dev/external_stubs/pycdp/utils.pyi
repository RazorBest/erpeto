...
class Retry(LoggerMixin):
    def __init__(self, func, exception_class: t.Collection[BaseException], loop: IEventLoop, *, retries: int = 1, on_error: str | t.Callable[[], t.Awaitable[None]] = None, log_errors: bool = False) -> None: ...
...
def retry_on(*exception_class: type[BaseException], loop: IEventLoop, retries: int = 1, delay: float | tuple[float, float] = 0.0, delay_growth: float = 1.0, max_delay: int = 600, log_errors: bool = False, on_error: str = None): ...
