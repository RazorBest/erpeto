...
def get_outer_html(node_id: NodeId | None = None, backend_node_id: BackendNodeId | None = None, object_id: runtime.RemoteObjectId | None = None) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, str]: ...
