...
def set_contents_size(window_id: WindowID, width: int | None = None, height: int | None = None) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]: ...
...
def add_privacy_sandbox_coordinator_key_config(api: PrivacySandboxAPI, coordinator_origin: str, key_config: str, browser_context_id: BrowserContextID | None = None) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]: ...
