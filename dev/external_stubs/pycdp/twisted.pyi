...
class CDPBase(LoggerMixin):
    def __init__(self, ws: t.Optional[CDPSocket] = None, session_id: Incomplete | None = None, target_id: Incomplete | None = None) -> None: ...
    @property
    ...
    async def wait_for(self, event_type: t.Type[T], buffer_size: int = 100) -> t.AsyncGenerator[T, None]: ...
